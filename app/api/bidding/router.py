...
async def bidding_auth(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="bidding_auth.html", context={"request": request, "current_user": current_user})
...
async def farmer_dashboard(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="bidding_farmer_dashboard.html", context={
        "request": request, 
...
async def bidder_dashboard(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="bidding_bidder_dashboard.html", context={
        "request": request, 
        "current_user": current_user, 
