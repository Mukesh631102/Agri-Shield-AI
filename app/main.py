...
app.include_router(advisory_router.router, prefix="/api/advisory", tags=["Advisory"])
...
async def market_page_ui(request: Request):
    return templates.TemplateResponse(request=request, name="market.html", context={"request": request})

@app.get("/crop-monitor", response_class=HTMLResponse)
async def crop_monitor_page_ui(request: Request):
    return templates.TemplateResponse(request=request, name="crop_monitor.html", context={"request": request})

@app.get("/flora-scan", response_class=HTMLResponse)
async def flora_scan_page_ui(request: Request):
    return templates.TemplateResponse(request=request, name="flora_scan.html", context={"request": request})
...
async def insurance_page_ui(request: Request):
    return templates.TemplateResponse(request=request, name="insurance.html", context={"request": request})
...
async def optimal_selling_page(request: Request):
    ...
    return templates.TemplateResponse(request=request, name="optimal_selling.html", context={
        "request": request,
...
async def smart_bidding_page(request: Request):
    return templates.TemplateResponse(request=request, name="smart_bidding.html", context={"request": request})

@app.get("/personalized-alerts", response_class=HTMLResponse)
async def personalized_alerts_page(request: Request):
